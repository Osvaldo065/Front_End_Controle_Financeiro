<template>
  <div class="max-w-md">
    ...
    <form @submit.prevent="salvar" class="space-y-4">
      ...
      <div>
        <label class="block text-sm mb-1" for="data">Data</label>
        <input
          id="data"
          v-model="form.data"
          type="date"
      ...
      <div>
        ...
        <select id="tipo" v-model="form.tipo_transacao" required class="w-full border border-line rounded px-3 py-2 bg-white">
      ...
      <div>
        ...
        <select id="status" v-model="form.status_pagamento" required class="w-full border border-line rounded px-3 py-2 bg-white">
